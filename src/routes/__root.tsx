...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "ClusterHire is an AI-powered candidate discovery and ranking platform that helps recruiters find, evaluate, understand, and manage the best candidates for every role." },
      { property: "og:title", content: "ClusterHire — AI candidate discovery and ranking" },
      { property: "og:description", content: "Find, evaluate, and hire the best candidates with an AI assistant that reads your pipeline and helps you rank your talent." },
